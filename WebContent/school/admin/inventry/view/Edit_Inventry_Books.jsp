<!--
 *Performs the Edit Inventry function in the frontend
                    ...
                    <div class="col-lg-6">
                            <section class="panel">
                           	...
                           	%>
                                               ...
                                               <td><a href="<%=Common_Things.url %>/edit-category/?sl_no=<%=obj_Book_Use_Bean.getInventry_sl_no() %>" class="btn btn-success btn-xs">Edit</a> </td>
                                            </tr>
                             		...
                             		while(it_list_books.hasNext()){
                             			obj_Book_Use_Bean=it_list_books.next();
                                             ...
                                             <td>
                                               ...
                                               <td>
                                                <a href="<%=Common_Things.url %>/edit-inventry-serial/?s=<%=obj_Book_Use_Bean.getSl_no() %>" class="btn btn-danger btn-xs">Edit</a>
