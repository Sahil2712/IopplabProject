<!--
 *Performs the Edit Profile From Student  function in the frontend
                                                    ...
                                                    <form action="<%=Common_Things.url%>/edit-profile-controller/" class="form-horizontal" role="form" method="post">
                                                        <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-2 control-label">User Name</label>
                                                            	<div class="col-sm-10">
                                                               	<input type="text" class="form-control" name="admission_no" data-parsley-required="true" data-parsley-trigger="change" placeholder="User Name" value="
                                                          
                                                               	admin
                                                               	" readonly="readonly">
                                                               </div> 
                                                             <!--  %if(obj_Admin_Use_Bean.getSl_no().isEmpty())
