<!--
 *Performs the Issue Book   function in the frontend
                                            ...
                                            <section class="panel">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form action="<%=Common_Things.url%>/issue-book-contr/" class="form-horizontal" role="form" method="post" name="myForm"  onsubmit="return validateForm()">
                                                    	...
                                                    	<input type="hidden" name="book_sl_no" value="<%=obj_Book_Use_Bean.getBook_sl_no() %>">
                                                    <input type="hidden" name="serial_sl_no" value="<%=inventry_sl %>"> 
